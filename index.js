...
console.log("🔑 Loaded API keys:", apiKeys.map(k => k.slice(0, 10) + "..."));
...
console.log(`🔑 Trying key ${i + 1}/${apiKeys.length}: ${apiKey.slice(0, 10)}...`);        
...
// Rotate key index for next call        
  currentKeyIndex = (currentKeyIndex + i + 1) % apiKeys.length;        
